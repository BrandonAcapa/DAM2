...
import es.rafapuig.pmdm.quotesapp.ui.components.QuoteListItem
import es.rafapuig.pmdm.quotesapp.ui.components.QuotesTopAppBar
import es.rafapuig.pmdm.quotesapp.ui.components.SearchBar
...
fun QuoteListScreen(
    ...
    val filteredQuotes = onFilter(query) // QuoteManager.filteredQuotes(query = query)
