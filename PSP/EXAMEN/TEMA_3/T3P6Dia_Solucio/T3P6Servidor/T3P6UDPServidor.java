...
public class T3P6UDPServidor {
	public static void main(String args[]) {

		DatagramSocket dSocket = null;

		if (args.length < 1) { // REBEM EN args EL PORT
			System.out.println("Utilització: java T3P6UDPServidor <número de port>");
			System.exit(1);
		}

		try {
			int socket_no = Integer.valueOf(args[0]).intValue(); // GUARDE EL NÚMERO DE PORT
			...
			while (true) {
				...
				// AIXÒ ÉS PER SI LA DATA ÉS 31-2-2016. AL FER parse, LA DATA SERA 2-3-2016.
				...
				// System.out.println("El dia de la setmana és: " + dataString);
