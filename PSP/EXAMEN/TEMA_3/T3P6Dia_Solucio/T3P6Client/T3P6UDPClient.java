...
public class T3P6UDPClient {
	...
	public static void main(String args[]) {
		...
		if (args.length < 2) {
			System.out.println("Utilització: java T3P6UDPClient <nom del Host> <número de port>");
			System.exit(1);
		}
		...
		try {
			...
			System.out.println("Introducció de la data ------");
			...
			do {
				System.out.println("Introducció de l'any (major que 1800):");
				cadena = in.nextLine();
				i = Integer.parseInt(cadena);
			} while (i < 1800);
			data = data + "-" + cadena;
